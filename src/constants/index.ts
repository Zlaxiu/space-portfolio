...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:"A responsive website for a gutter replacement and repair service, designed to clearly present services, build trust with clients, and ensure smooth navigation.",
    tech:["wordpress","css","php"],
  ...
  },
  {
    ...
    description:"A clean and responsive website for an educational loan program, designed to present information clearly and provide an intuitive experience for users.",
    tech:["wordpress","css","php"],
